...
class EditUser extends StatefulWidget {
  ...
  const EditUser(this.user, {Key key}) : super(key: key);
...
class _EditUserState extends State<EditUser> {
  ...
  void initState() {
    ...
    _specialization.text = widget.user.specialization;
    _graduate.text = widget.user.graduate;
    _roleId = widget.user.roleId;
    _activePicked = widget.user.active ?? false;
    _availableTime = widget.user.availableTime;
    _price.text = widget.user.price;
    if (_gender == 'L') {
      _isMale = true;
    } else {
      _isFemale = true;
              ...
              Button(
                ...
                select: _isLoading
                    ...
                    : () async {
                        if (validateRegister()) {
                          try {
                            await Provider.of<ListUserProvider>(context, listen: false).updateUser(
                              email: _email.text,
                              name: _name.text,
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                              content: Text('Success update user profile'),
                            ...
                            await Provider.of<ListUserProvider>(context, listen: false)
